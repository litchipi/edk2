  ...
  )
{
  ...
  GetMemoryPermissionsSvcArgs.Arg0 = ARM_SVC_ID_FFA_MSG_SEND_DIRECT_REQ_AARCH32;
  GetMemoryPermissionsSvcArgs.Arg1 = 0x3;
  GetMemoryPermissionsSvcArgs.Arg2 = 0;
  GetMemoryPermissionsSvcArgs.Arg3 = ARM_SVC_ID_SP_GET_MEM_ATTRIBUTES_AARCH32;
  ...
  )
{
  ...
  ChangeMemoryPermissionsSvcArgs.Arg0 = ARM_SVC_ID_FFA_MSG_SEND_DIRECT_REQ_AARCH32;
  ChangeMemoryPermissionsSvcArgs.Arg1 = 0x3;
  ChangeMemoryPermissionsSvcArgs.Arg2 = 0x0;
  ChangeMemoryPermissionsSvcArgs.Arg3 = ARM_SVC_ID_SP_SET_MEM_ATTRIBUTES_AARCH32;
